...
chart3 <- economics %>% ggplot(aes(x=unemploy,y=psavert)) + geom_point(aes(color = uempmed)) 
chart3

#11. Interpret what you see in this last graph
#This shows that as the unemployment rate increases, the personal saving rate also decreases. More unemployment = less disposable income.
